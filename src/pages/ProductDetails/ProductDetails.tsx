      ...
      <Grid container spacing={4}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
            ...
            {product.discountPercentage > 0 ? (
              <>
                <Stack direction='row' alignItems='baseline' spacing={2}>
                  ...
                  <Chip label={`Save $${savings.toFixed(2)}`} color='success' variant='outlined' size='small' />
                </Stack>
              </>
            ) : (
              <Typography variant='h3' color='primary' fontWeight='bold'>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} mb={4}>
            ...
            <CartButton product={product} quantity={quantity} variant='contained' fullWidth />
          </Stack>
          ...
          <Alert severity='info' icon={false} sx={{ mb: 2 }}>
            <Stack direction='row' spacing={1} alignItems='center'>
              <DeliveryIcon />
              <Typography variant='body2'>Free shipping on orders over $50 • Delivery in 2-3 days</Typography>
            </Stack>
          </Alert>
        </Grid>
      </Grid>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Accordion defaultExpanded>
                ...
                <AccordionDetails>
                  ...
                  <Stack spacing={1}>
                    <Typography variant='body1'>• Free shipping on orders over $50</Typography>
                    <Typography variant='body1'>• Standard shipping: 2-3 business days</Typography>
                    <Typography variant='body1'>• Express shipping: 1 business day ($9.99)</Typography>
                  </Stack>
                </AccordionDetails>
              </Accordion>
            </Grid>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Accordion defaultExpanded>
                ...
                <AccordionDetails>
                  ...
                  <Stack spacing={1}>
                    <Typography variant='body1'>• 30-day return policy</Typography>
                    <Typography variant='body1'>• Product must be in original packaging</Typography>
                    <Typography variant='body1'>• Free returns for damaged items</Typography>
                  </Stack>
                </AccordionDetails>
              </Accordion>
            </Grid>
