    ...
    <Container maxWidth='lg'>
      ...
      <Grid container spacing={3}>
        {wishlistItems.map(item => {
          ...
          const discountPrice = hasDiscount ? calculateDiscountPrice(item.price, item.discountPercentage) : item.price;
                ...
                <Box sx={{ p: 2, pt: 0 }}>
                  ...
                  >
                    <Box sx={{ flexGrow: 1 }} onClick={e => e.stopPropagation()}>
                      <CartButton product={item} variant='contained' size='small' fullWidth />
                    </Box>
                    <IconButton color='error' onClick={e => handleRemoveFromWishlist(e, item.id)}>
                      <DeleteIcon />
                    </IconButton>
                  </Box>
                </Box>
